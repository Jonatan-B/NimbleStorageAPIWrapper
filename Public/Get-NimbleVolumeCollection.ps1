function Get-NimbleVolumeCollection {
    param(
        ...
        [Parameter(Position=0, Mandatory, ValueFromPipeline, ValueFromPipelineByPropertyName, ParameterSetName="ListVolumeCollections")]
        [Switch]
        $List,
        # Should we list all of the VolumeCollections with details?
        [Parameter(Position=0, Mandatory, ValueFromPipeline, ValueFromPipelineByPropertyName, ParameterSetName="VolumeCollectionsDetail")]
        [Switch]
        $ListWithDetails,
        # Query for a specific VolumeCollection ID
        [Parameter(Position=0, Mandatory, ValueFromPipeline, ValueFromPipelineByPropertyName, ParameterSetName="VolumeCollectionId")]
        [String]
        $VolumeCollectionId,
